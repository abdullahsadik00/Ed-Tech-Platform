...
const AboutUs = () => {
  return (
    <section id="aboutUs">
      <div className="flex items-center justify-center container mx-auto md:max-w-5xl border-1 pt-10 pb-4 sm:mx-auto flex-col">
        <div className="mb-20">
        ...
        {/* End Teams */}
        <div className="flex w-full border rounded border-transparent flex-col md:flex-row">
          <div className="w-full md:w-[40%] bg-[#636AE8] p-8 flex justify-center items-center">
            <div>
              <h2 className="text-white text-3xl font-poppins leading-4 tracking-wide font-semibold">
                Let's work together!
              </h2>
